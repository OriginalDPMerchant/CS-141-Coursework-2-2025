...
data GameRecordExt = GameRecordExt
    {
        isValid :: Bool,
        errorMsg :: String,
        lastPlayer :: Player,
...
data GridlockMove = GridlockMove Player Colour (Int, Int)
    deriving (Eq, Ord, Read, Show)
    
data GridlockASTNode 
    = Gridlock GridlockASTNode
    | Players (Player, Player) GridlockASTNode
    | GridSize (Int, Int) GridlockASTNode
    | Colours (Set Colour) GridlockASTNode
    | Move GridlockMove GridlockASTNode
    | Lose Player GridlockASTNode
    | Win Player GridlockASTNode
    | End
    deriving (Eq, Ord, Read, Show)
